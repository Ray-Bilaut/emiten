...
class Recommendation extends APP_Webtools {

	public function __construct()
	{
        parent::__construct();
        $this->_template_master_data['page_title'] = 'Recommendation';
	}
    ...
    public function index($error='')
    {
        ...
        $this->_data['list'] = $this->db->get_where('news', array('is_delete'=>0, 'is_recommendation'=> 1))->result();
    ...
    public function remove($idx)
    {
        ...
        $res = $this->db->update('news', ['is_recommendation' => 0], ['id' => $idx]);
