...
class Newsreporter extends APP_Webtools {
    ...
    public function index($error='', $year='2021')
    {
        ...
        $idx = $this->_template_master_data['user']->id;
        $authorFlag = $this->_template_master_data['user']->group == 4 ? 'expert_id' : 'author_id';
        $this->_data['list'] = $this->db->get_where('news', array('is_delete'=>0, $authorFlag=>$idx, 'publish_date >='=> $year.'-01-01 00:00:00', 'publish_date <='=> $yearint.'-01-01 00:00:00'))->result();
