        ...
        <div class="row-flex row-flex-between">
            <div class="detail-left">
                ...
                <div class="text-detail-news dual-theme">
                    ...
                    <div><?php echo $news->sliced_desc ?></div>
                    <br>
                    ...
                    <div class="tags-news">
                        ...
                        <?php endforeach; ?>
                        <div class="count-like" data-type="news" data-identifier="news_id" data-nid="<?php echo $news->id ?>"> <p id="like-count"> <?php echo $likes->total > 0 ? $likes->total : '' ?> </p><i class="fa fa-thumbs-up"></i> </div>
                    </div>
