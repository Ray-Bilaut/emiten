            ...
            <div class="detail-left">
                <div class="adsanse-left">
                    <?php if (ENVIRONMENT == 'production') : ?>
                        ...
                        <!-- news_detail_left -->
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-1508023122152906" data-ad-slot="3859420972" data-ad-format="auto" data-full-width-responsive="true"></ins>
                        <script>
                            (adsbygoogle = window.adsbygoogle || []).push({});
                        </script>
                    <?php endif; ?>
                </div>
                <div class="text-detail-news dual-theme">
                    <div class="image-detail">
                        <img src="<?php echo $news->image_url ?>" alt="<?php echo $news->title ?>">
                    </div>

                    <div class="news-wrap"><?php echo $news->sliced_desc ?></div>
                    <br>
                    <h1>Author: <?php echo $news->author ?></h1>
                    ...
                    <div class="tags-news">
                        <?php foreach ($tags as $tag) : ?>
                            <a href="<?php echo base_url('tag/' . $tag->slug_url) ?>">
                                <div class="item-tags">#<?php echo $tag->title ?></div>
                            </a>
                        <?php endforeach; ?>
                        <div class="count-like" data-type="news" data-identifier="news_id" data-nid="<?php echo $news->id ?>">
                            <p id="like-count"> <?php echo $likes->total > 0 ? $likes->total : '' ?> </p><i class="fa fa-thumbs-up"></i>
                        </div>
                    </div>

                    <?php if (!empty($news->file_attachment)) { ?>
                        <div class="download">
                            <p>Download File:</p>
                            <a href="<?php echo base_url('uploads/file_news/' . $news->file_attachment) ?>" download="<?php echo $news->file_attachment ?>"><i class="fa fa-download"></i>&nbsp; <?php echo $news->file_attachment ?></a>
                        </div>
                    <?php } ?>
                ...
                <?php if (ENVIRONMENT == 'production') : ?>
                    <div class="container-category related-news">
                        ...
                        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                        <!-- news_detail_center -->
                        <ins class="adsbygoogle news_detail_center" style="display:block" data-ad-client="ca-pub-1508023122152906" data-ad-slot="8985138036" data-ad-format="auto" data-full-width-responsive="true"></ins>
                        <script>
                            (adsbygoogle = window.adsbygoogle || []).push({});
                        </script>
                    </div>
                    ...
                    <?php if (count($relatedNews) > 0) : ?>
                        ...
                        <div class="list-news-home">
                            <div class="news-home-pin dual-theme">
                                <a href="<?php echo $relatedNews[0]->detail_url ?>">
            ...
            <div class="detail-right">
                ...
                <?php if (ENVIRONMENT == 'production') : ?>
                    <div class="adsanse-box-detail">
                        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                        <!-- news_detail_right -->
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-1508023122152906" data-ad-slot="6031671634" data-ad-format="auto" data-full-width-responsive="true"></ins>
                        <script>
                            (adsbygoogle = window.adsbygoogle || []).push({});
                        </script>
                    </div>
        ...
        <div class="content-comment">
            <div class="section-comment">
                <div class="box-comment dual-theme">
                    <form id="form-comment" role="form" method="POST" action="<?php echo base_url("ajax/comment/news_id/" . $news->id . "/news"); ?>">
