<div class="container-fluid">
    <div class="row-flex row-flex-between">
        <div class="section-expert-left">
            <div class="bio-expert">
                <img src="<?php echo $expert->image_url?>" alt="<?php echo $expert->name ?>">
                <div class="text-bio-expert dual-theme">
                    <h1><?php echo $expert->name ?></h1>
                    <p><?php echo $expert->bio ?></p>
                </div>
            </div>
            <div class="list-category">
                <?php foreach($news as $n):?>
                    <a href="<?php echo $n->detail_url ?>">
                        <div class="item-list-category">
                            <img src="<?php echo $n->thumb_url ?>" alt="<?php echo $n->title?>">
                            <div class="text-list-category dual-theme">
                                <h1><?php echo $n->title ?></h1>
                                <p><?php echo $n->pretty_time ?></p>
                            </div>
                        </div>
                    </a>
                <?php endforeach;?>
