            ...
            <div class="detail-left">
                ...
                <div class="text-detail-news dual-theme">
                    ...
                    <?php if ($news->type == 1) { ?>
                        ...
                        src="https://www.youtube.com/embed/<?php echo $news->file_name?>">
                        </iframe>
                    <?php } else { ?>
                        <iframe src="https://open.spotify.com/embed-podcast/episode/<?php echo $news->file_name?>" width="100%" height="232" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <?php } ?>
                    <br><br>
                    ...
                    <div class="tags-news">
                        ...
                        <?php endforeach; ?>
                        <div class="count-like" data-type="podcast" data-identifier="podcast_id" data-nid="<?php echo $news->id ?>"> <p id="like-count"> <?php echo $likes->total > 0 ? $likes->total : '' ?> </p><i class="fa fa-thumbs-up"></i> </div>
                    </div>
        ...
        <div class="content-comment">
            <div class="section-comment">
                <div class="box-comment dual-theme">
                    <form id="form-comment" role="form" method="POST" action="<?php echo base_url("ajax/comment/podcast_id/".$news->id."/podcast"); ?>">
