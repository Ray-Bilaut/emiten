<div class="row">
  <div class="col-xs-12">
		<div class="box box-primary">
            <form role="form" enctype="multipart/form-data" method="POST" action="<?php echo site_url(ADMIN_URL.'/admin/editprocess/'.$admin->id); ?>">
              	<div class="box-body">
                  ...
                  <!-- <a class="btn btn-default" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo site_url(ADMIN_URL.'/admin/delete/'.$admin->id); ?>">Delete</a> -->
