...
<div class="col-xs-12">
  ...
  <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          <img width="200px" class="img-responsive" src="<?php echo base_url('uploads/infographic/'.$data->thumb) ?>">
        </div>
        <?php endif; ?>
        ...
        <div class="form-group">
          <img width="200px" class="img-responsive" src="<?php echo base_url('uploads/infographic/'.$data->image) ?>">
        </div>
        <?php endif; ?>
        ...
        <div class="form-group">
          <img width="200px" class="img-responsive" src="<?php echo base_url('uploads/infographic/'.$data->image_mobile) ?>">
        </div>
        <?php endif; ?>
