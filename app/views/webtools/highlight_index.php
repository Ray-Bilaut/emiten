              ...
              <tr>
                ...
                <td>
                  <div class="btn-group pull-right">
                    <a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to remove this data from highlight?');" href="<?php echo site_url(ADMIN_URL.'/'.$this->router->class.'/remove/'.$v->id); ?>" title="Remove from Highlight"><i class="fa fa-close"></i> Remove from Highlight</a>
                  </div>
                </td>
              </tr>
            <?php endforeach; ?>
